...
//        //number of tries to solve the task (if it is possible)
//        private int number_of_tries_to_solve = 0;

//        //the timer used to measure time on a separate task/turn/quest
//        private Stopwatch count_time_on_task = new Stopwatch();

//        //collection for storing the time used on this task/turn/quest 
//        //!!!!!!!!!!!!!!!!store if task was completed succesfully
//        private List<TimeSpan> list_of_count_time_on_task = new List<TimeSpan>();
...
//        //can take decimal numbers for inputing seconds for instance)
//        //can be used by the users to set time limit upon the players for tasks/turns/etc. in games
//        private TimeSpan task_time_limit_input = new TimeSpan();
...
//        public List<TimeSpan> GetListOfTimesOnTask()
//        {
//            return list_of_count_time_on_task;
//        }
...
//        public TimeSpan GetTimeOnTask()
//        {
//            return count_time_on_task.Elapsed;
//        }
...
//        //function to increment the number of tries to solve the task
//        void IncrementNumberOfTriesToSolve()
//        {
//            number_of_tries_to_solve++;
//        }
...
//        //get the input for the time limit from the game/user and store it
//        public void CheckAndStoreInputTimeLimit(string input_time)
//        {
//            //Utilities utilityObject = new Utilities();
...
//        //start or stop the counter for the time since the player started a task
//        //add a name to the task (so it can be identified)
//        //and also save the time spent in a list
//        public void StartAndStopTimeCounterAndAddNameForTheTask(bool start_or_stop_flag, string task_name)
//        {
...
//            {
//                count_time_on_task.Start();
//            }
//            else
//            {//or stop it and store the time
//                count_time_on_task.Stop();
//                list_of_count_time_on_task.Add(count_time_on_task.Elapsed);
//            }
//        }
