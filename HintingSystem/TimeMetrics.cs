...
namespace Prototype1v1
{
    public class TimeMetrics //: IMetrics
    {
        ...
        /*public*/
        private List<bool> game_time_limit_compared = new List<bool>();
        /*{
            get;
            set;
        }*/
...
//        //used to check if the player is actively doing something
//        private List<TimeSpan> activityTimestamps = new List<TimeSpan>();

//        //keeps track of time from the start of a game/session to the end
//        private Stopwatch count_time_since_beginning_of_game = new Stopwatch();

//        //storage of the time from the start of a game/session to the end
//        //could be usefeul for the logging of data when the system closes
//        private TimeSpan stored_count_time_since_beginning_of_game = new TimeSpan();

//        //a collection of time slices that the player spent doing a game specific action
//        //???????maybe a dictionary with string as key for flexibility and having multiple actions
//        private Dictionary<string, TimeSpan> time_since_action = new Dictionary<string, TimeSpan>();
...
//        //the game time limit based on the user of the hinting system or the game (needs input in minutes,
//        //can take decimal numbers for inputing seconds for instance)
//        //can be used by the users to set time limit upon the players for how long the game should be played
//        private TimeSpan game_time_limit_input;
...
//        public TimeSpan GetStoredCountTimeSinceBeginningOfGame()
//        {
//            return stored_count_time_since_beginning_of_game;
//        }

//        public void SetStoredCountTimeSinceBeginningOfGame(TimeSpan new_value)
//        {
//            stored_count_time_since_beginning_of_game = new_value;
//        }

//        public TimeSpan GetCountTimeSinceBeginningOfGame()
//        {
//            return count_time_since_beginning_of_game.Elapsed;
//        }
...
//            if (start_or_stop_flag)
//            {
//                count_time_since_beginning_of_game.Start();
//            }
//            else
//            {
//                count_time_since_beginning_of_game.Stop();
//                SetStoredCountTimeSinceBeginningOfGame(count_time_since_beginning_of_game.Elapsed);
//            }
//        }
